...
import { LIZARD_DATA } from '../data/LizardData.js';
...
const styles = {
    ...
    containerLayout: { display: 'flex', gap: '30px', alignItems: 'flex-start', flexWrap: 'wrap' },
    sidebar: { width: '240px', minWidth: '240px', backgroundColor: '#fdfcfb', borderRadius: '12px', border: '1px solid #e0d9d0', overflow: 'hidden', flexShrink: 0  }, 
    ...
    infoDetails: { flex: 1, paddingLeft: '10px', minWidth: '0' }, 
